...
function setupAndRegister(userIdentifier, password, identifiers = undefined,
    argonIterations = undefined, argonMemory = undefined, argonParallelism = undefined
)
{
...
describe("specifying argon2 parameters", () =>
{
    test('same parameters work', () =>
    {
        const userIdentifier = "user123";
        const password = "hunter42";
        ...
        const {
            ...
            exportKey: registrationExportKey,
            serverStaticPublicKey: registrationServerStaticPublicKey,
        } = setupAndRegister(userIdentifier, password, undefined, argonIterations, undefined, argonParallelism);
    ...
    test('different parameters fail', () =>
    {
        const userIdentifier = "user123";
        const password = "hunter42";

        const registerIterations = 5;
        const registerParallelism = 2;

        const loginIterations = 3;
        const loginParallelism = 3;
        ...
        const {
            ...
            exportKey: registrationExportKey,
            serverStaticPublicKey: registrationServerStaticPublicKey,
        } = setupAndRegister(userIdentifier, password, undefined, registerIterations, undefined, registerParallelism);
        ...
        const loginResult = opaque.client.finishLogin({
            ...
            password,
            undefined,
            argonIterations: loginIterations,
            argonParallelism: loginParallelism
        });
