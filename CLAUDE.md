...
`CHANGELOG.md` (root) and `build/*/CHANGELOG.md` are generated by `changeset version` — never edit them by hand. The only exception is the reconstructed historical section for versions before 0.8.1.
