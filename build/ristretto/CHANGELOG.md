...
- Add a P-256 build published as `@serenity-kit/opaque-p256` next to the default Ristretto255 build
...
- Initial release. The OPAQUE protocol implemented in Rust on top of `opaque-ke`, compiled to WebAssembly and exposed through TypeScript bindings, covering the full registration and login flows including custom identifiers, export keys and the server static public key.
